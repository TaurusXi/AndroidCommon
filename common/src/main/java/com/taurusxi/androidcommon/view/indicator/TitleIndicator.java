...
import com.taurusxi.androidcommon.utils.DisplayUtil;
import com.taurusxi.androidcommon.view.indicator.observer.ObservableView;
...
public class TitleIndicator extends FrameLayout implements ObservableView {
    ...
    private TextView internalCreateTextView(Context context, AttributeSet attrs) {
        ...
        textView.setTextSize(DisplayUtil.dip2px(15));
        return textView;
    }


    public void setTextSize(int size) {
        textViewSwitcher.setTextSize(size);
        textViewTitle.setTextSize(size);
    }

    public void setTextColor(int color) {
        textViewSwitcher.setTextColor(color);
