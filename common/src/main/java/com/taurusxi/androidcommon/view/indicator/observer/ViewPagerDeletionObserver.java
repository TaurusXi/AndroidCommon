package com.taurusxi.androidcommon.view.indicator.observer;
 ...
 */
public class ViewPagerDeletionObserver implements ViewPager.OnPageChangeListener {
    ...
    public ViewPagerDeletionObserver(ViewPager mViewPager) {
        if (mViewPager == null) {
