...
public class ThridFourFrameLayoutLayout extends LinearLayout {
    public ThridFourFrameLayoutLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ThridFourFrameLayoutLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ThridFourFrameLayoutLayout(Context context) {
        super(context);
    }
