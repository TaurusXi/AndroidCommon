 ...
 * @date Oct 31, 2014
 */
public class ShowTipsViewRelative extends RelativeLayout {
    ...
    public ShowTipsViewRelative(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public ShowTipsViewRelative(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShowTipsViewRelative(Context context) {
        super(context);
        init();
    }
