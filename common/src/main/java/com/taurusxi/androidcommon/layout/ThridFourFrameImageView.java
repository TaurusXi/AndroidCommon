...
public class ThridFourFrameImageView extends ImageView {
    public ThridFourFrameImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ThridFourFrameImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ThridFourFrameImageView(Context context) {
        super(context);
    }
